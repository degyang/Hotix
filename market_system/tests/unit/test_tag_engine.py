...
def test_detect_index_transitions_returns_expected_tags(index_runtime_ready, prev_index_runtime, dsl_bundle):
    runtime = detect_index_transitions(index_runtime_ready, dsl_bundle["transitions"], prev_index_runtime)
