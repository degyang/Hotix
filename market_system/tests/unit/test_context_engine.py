...
def test_score_market_context_selects_cash_with_evidence(dsl_bundle, market_runtime_ready, ready_indices, ready_pairs):
    market_runtime_ready.market_regime = {"label": "混沌市", "score": 2.0, "confidence": 0.6, "evidence": ["未形成明确结构主线"]}
    ...
    result = score_market_context(market_runtime_ready, ready_indices, ready_pairs, dsl_bundle["contexts"])
